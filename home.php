  ...
  <header>
    <div class="container">
      ...
      <nav class="top_nav d-flex pt-3 pb-1">
        <!-- logo -->
        <h1>
          <a class="navbar-brand" href="/">Clothing-Ally </a>
        </h1>
        <!-- //logo -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light justify-content-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto text-center">
            ...
            <li class="nav-item dropdown has-mega-menu" style="position: static">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                aria-expanded="false">Women's clothing</a>
              <div class="dropdown-menu" style="width: 100%">
                <div class="px-0 container">
                  <div class="row">
                    <div class="col-md-4">
            ...
            <li class="nav-item dropdown has-mega-menu" style="position: static">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                aria-expanded="false">Kids Clothing</a>
              <div class="dropdown-menu" style="width: 100%">
                <div class="container">
      ...
      <ul class="rslides" id="slider3">
        ...
        <li class="banner banner3">
          <div class="container">
            ...
            <div class="slider-info mt-sm-5">
              <h4 class="bn_right">
                <span>k</span>id's <span>f</span>ashion
              </h4>
              <div class="bnr_clip position-relative">
                <h4>
                  get up to
    ...
    <div class="col-sm-4">
      <div class="hovereffect">
        ...
        <div class="overlay">
          ...
          <a class="info"
            href="https://www.shopbop.com/sale/br/v=1/13594.htm?extid=affprg_linkshare_SB-J84DHJLQkR4&cvosrc=affiliate.linkshare.J84DHJLQkR4&clickid=Ux5RYZxO6xyJUbT0UfQwQyYMUkgQAawcYznBy40&subid1=J84DHJLQkR4-AMadgLHa_Fuw9g.w2_d.kw&sharedid=42352">Shop
            Now</a>
        </div>
      </div>
    </div>
        ...
        <ul id="clothing-nav" class="nav nav-tabs tabs-style-line" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="#women" id="women-tab" role="tab" data-toggle="tab" aria-controls="women"
              aria-expanded="true">Women's Fashion</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#girl" role="tab" id="girl-tab" data-toggle="tab" aria-controls="girl">Girl's
              Fashion</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#boy" role="tab" id="boy-tab" data-toggle="tab" aria-controls="boy">Boy's
              Fashion</a>
          </li>
        </ul>
      </nav>
